...
def parse():
    ...
    parser.add_argument("--configuration", help="Model configuration file", default="ci/frcnn/sagemaker_default_model_config.py")
    parser.add_argument("--main_script", help="entrypoint for training script", default="ci/frcnn/train_sagemaker.py")
